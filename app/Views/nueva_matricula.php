<h5 style="color:#016887;padding-top:5px">Matrículas - Nueva matrícula</h5>
	<div class="container">				
				...
				<div class="card">
				  ...
				  <div class="card-body">
						...
						<div class="row form-group">
						  <div class="col-sm-6">
							<label>Nombre</label>
							<input name="nombreAbogado" id="nombreAbogado" type="text" class="form-control required" placeholder="Ingrese su nombre" data-required="true" value="<?php echo $datos_abogado[0]['Nombre']?>" disabled>							
						   </div>
						  <div class="col-sm-6">
							<label>Apellido</label>
							<input name="apellidoAbogado" id="apellidoAbogado" type="text" class="form-control required" placeholder="Ingrese su apellido" data-required="true" value="<?php echo $datos_abogado[0]['Apellido'] ?>" disabled>												
						  </div>
						</div>
						<div class="row form-group">
							<div class="col-sm-6">
							<label>Cuit</label>
								<input name="cuitAbogado" id="cuitAbogado" onkeyup="valida_cadena(event, this) "type="text" class="form-control integer number required" minlength="11" maxlength="11" placeholder="Ingrese su nro. de CUIT" value="<?php echo $datos_abogado[0]['Cuit'] ?>" disabled>
							</div>			
						</div>						
						...
						<div class="row form-group">
							<div class="col-sm-12">
								...
								<div style="float:left !important" class="form-check form-check-inline">
								  ...
								  <label style="font-size:15px" class="form-check-label" >Declararo no haber sido empleado de ninguna ART ni empresa del grupo económico de las mismas durante los 2 (dos) años anteriores a su inscripción.</label>
								</div>		
							</div>		
						</div>			
  ...
  <div class="modal-dialog modal-lg" role="document">
	<div class="modal-content">
	  ...
	  <div class="modal-body">
			...
			•	Será obligación del profesional estar disponible para la atención remota a través de su teléfono celular y correo electrónico, conforme funcionamiento del e-Servicios SRT Sistema de Ventanilla Electrónica disponible en el portal de AFIP, Res . SRT 22/18.<br>
			...
			•	El profesional deberá acceder con los datos de su usuario y contraseña a la plataforma que le será indicada y que constituirá la vía de comunicación obligatoria y exclusiva para informar sobre el resultado de las labores realizadas y sobre los datos que se le requieran respecto de la implementación del programa y la auditoría de la gestión. Completar la información requerida en el sistema tiene carácter obligatorio.<br>
			•	El abogado o abogada que sea sorteado se encuentra obligado a aceptar el caso y tramitarlo hasta su finalización. En caso de verificarse alguna causal por la cual deba excusarse de atender al cliente, incompatibilidad, inhabilidad o prohibición para la toma del asunto, la misma deberá ser comunicada dentro de la 24 horas al Colegio Departamental donde está matriculado, a los fines de su admisión o rechazo. En el caso de que el letrado no pueda aceptar el caso por motivos imputables al trabajador, en idéntico plazo deberá informar dicha circunstancia, con explicación de lo acontecido.<br>
			...
			•	Independientemente de que el domicilio del trabajador determina el Colegio Departamental interviniente en la designación, el profesional designado podrá actuar ante cualquiera de las solicitar las comisiones médicas previstas por el art. 1 párrafo 2 ley nº 27348, quedando totalmente habilitado al ejercicio de la triple opción allí prevista.<br>
			•	El letrado se compromete a guardar la más estricta confidencialidad y secreto profesional en relación a los asuntos encomendados y demás datos a los que acceda por su intervención en el presente programa, como así también se responsabiliza por la seguridad de la información que manejare a resultas del mismo en los términos de la ley 25.326.<br>
			•	El abogado deberá declarar bajo juramento que no ha sido empleado en relación de dependencia de ninguna ART ni empresa del grupo económico perteneciente a alguna de ellas, ni de la SRT, ni de empleadores autoasegurados, ni de ningún sindicato, durante los 2 (dos) años anteriores a la firma del presente.<br>
		</p>
	  </div>
	  <div class="modal-footer">
  ...
  <div class="modal-dialog" role="document">
	<div class="modal-content ">
		...
		<div class="modal-body">		
			...
			<div class="modal-footer">
				<form class="form-inline" action="imprimir_comprobante_inscripcion" method="post" enctype="multipart/form-data" id="descargarpdf1" name="descargarpdf1">
