...
header('Content-Disposition: attachment;filename="Listado de incriptos por colegio profesional.xls"');
		...
		<table class="table table-striped" id="tabla-incriptos">
			  <thead>
				<tr>									  
				  ...
				  <th style="text-align:center;background-color:#00B4CE">Colegio Profesional</th>												 													  
			  ...
			  <tbody>
				<?php foreach ($reportes as $reporte) {?>						<tr>		
					  											
						<td style="text-align:left"><?php echo utf8_decode(strtoupper($reporte['Colegio']))?></td>											
