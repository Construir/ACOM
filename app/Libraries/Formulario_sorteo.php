...
class Formulario_sorteo{	
	...
	public function imprimir($data){
		...
		<body>
						...
						<tbody>
							<tr>
								...
								<td style="text-align:left;width:400px">																		
									<label><strong>Número de sorteo:</strong> '.$data["IdConsulta"].'</label>
								</td>
								
								<td style="text-align:right;width:400px">
									<label><strong>Fecha de sorteo:</strong> '.$data["FechaSorteo"].'</label>										
								</td>
							</tr>
						</tbody>
					</table>
						...
						<table>
							<tr>
								<td>
									...
									<label><strong>Apellido y Nombre:</strong> '.strtoupper($data["NombreyApellidoAbogado"]).'</label><br>
									...
									<label><strong>Localidad:</strong> '.$data["Localidad"].'</label><br>
					...
					<div class="card">
						...
						<div class="card-body">
							...
							<img style="float:right" src="https://chart.googleapis.com/chart?chs=150x150&cht=qr&chl=https://acom.org.ar/acom/ver_comprobante_sorteo?id_consulta='.$data["IdConsulta"].'" width="90" height="90" ></img>
						</div>			  
					</div>
		...
		$mpdf->Output('Acom(Comprobante de sorteo).pdf', \Mpdf\Output\Destination::DOWNLOAD);
